...
const ShimmerButton = ({ children, className, ...props }) => {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-brand-primary px-6 font-medium text-white backdrop-blur-3xl">
        {children}
      </span>
    </button>
  );
